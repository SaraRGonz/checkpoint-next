    ...
    return (
        <div className="bg-card p-8 rounded-lg shadow-lg border border-border w-full max-w-md flex flex-col items-center gap-6">
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-[#24292e] hover:bg-[#2f363d] text-white px-6 py-3 rounded-md font-semibold transition-colors duration-200"
            >
            ...
            <div className="w-full flex items-center gap-4 mt-4 text-sm text-text/50">
